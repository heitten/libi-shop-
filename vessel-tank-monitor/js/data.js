...
const DEFAULT_TANKS = [
  ...
  { id: 'fo1_p', group: 'FUEL_OIL', name: 'No.1 FO Tk (P)', frame: '47~61', capacity: 31.7, spgr: 0.850, verified: true },
  ...
  { id: 'dwwb_ap_c', group: 'DRILL_WATER', name: 'DW/WB AP Tk (C)', frame: 'AE~(-2)', capacity: 26.9, spgr: 1.000, verified: true },
  { id: 'dwwb_ap_p', group: 'DRILL_WATER', name: 'DW/WB AP Tk (P)', frame: 'AE~3', capacity: 18.3, spgr: 1.000, verified: true },
  { id: 'dwwb_ap_s', group: 'DRILL_WATER', name: 'DW/WB AP Tk (S)', frame: 'AE~3', capacity: 18.3, spgr: 1.000, verified: true },
  { id: 'dwwb_fp_c', group: 'DRILL_WATER', name: 'DW/WB FP Tk (C)', frame: '81~88', capacity: 84.6, spgr: 1.000, verified: true },
  { id: 'dw1db_c', group: 'DRILL_WATER', name: 'No.1 DW/WB DB Tk (C)', frame: '47~63', capacity: 72.6, spgr: 1.000, verified: true },
  { id: 'dw2_p', group: 'DRILL_WATER', name: 'No.2 DW/WB Tk (P)', frame: '47~63', capacity: 46.1, spgr: 1.000, verified: true },
  { id: 'dw2_s', group: 'DRILL_WATER', name: 'No.2 DW/WB Tk (S)', frame: '47~63', capacity: 46.1, spgr: 1.000, verified: true },
  { id: 'dw3db_c', group: 'DRILL_WATER', name: 'No.3 DW/WB DB Tk (C)', frame: '32~47', capacity: 78.6, spgr: 1.000, verified: true },
  { id: 'dw4_p', group: 'DRILL_WATER', name: 'No.4 DW/WB Tk (P)', frame: '32~47', capacity: 46.7, spgr: 1.000, verified: true },
  { id: 'dw4_s', group: 'DRILL_WATER', name: 'No.4 DW/WB Tk (S)', frame: '32~47', capacity: 46.7, spgr: 1.000, verified: true },
  { id: 'dw5_p', group: 'DRILL_WATER', name: 'No.5 DW/WB Tk (P)', frame: '24~32', capacity: 38.6, spgr: 1.000, verified: true },
  { id: 'dw5_s', group: 'DRILL_WATER', name: 'No.5 DW/WB Tk (S)', frame: '24~32', capacity: 38.6, spgr: 1.000, verified: true },
  { id: 'dw6_p', group: 'DRILL_WATER', name: 'No.6 DW/WB Tk (P)', frame: '15~24', capacity: 39.1, spgr: 1.000, verified: true },
  { id: 'dw6_s', group: 'DRILL_WATER', name: 'No.6 DW/WB Tk (S)', frame: '15~24', capacity: 39.1, spgr: 1.000, verified: true },
  { id: 'dw7_p', group: 'DRILL_WATER', name: 'No.7 DW/WB Tk (P)', frame: '6~15', capacity: 29.9, spgr: 1.000, verified: true },
  { id: 'dw7_s', group: 'DRILL_WATER', name: 'No.7 DW/WB Tk (S)', frame: '6~15', capacity: 29.9, spgr: 1.000, verified: true },

  // ---- FRESH WATER (Spgr 1.000) ----
  { id: 'fw1_p', group: 'FRESH_WATER', name: 'No.1 FW Tk (P)', frame: '71~79', capacity: 29.4, spgr: 1.000, verified: true },
  { id: 'fw1_s', group: 'FRESH_WATER', name: 'No.1 FW Tk (S)', frame: '71~79', capacity: 29.4, spgr: 1.000, verified: true },
  { id: 'fw2db_p', group: 'FRESH_WATER', name: 'No.2 FW DB Tk (P)', frame: '63~73', capacity: 33.6, spgr: 1.000, verified: true },
  { id: 'fw2db_s', group: 'FRESH_WATER', name: 'No.2 FW DB Tk (S)', frame: '63~73', capacity: 34.2, spgr: 1.000, verified: true },
  { id: 'fw3_p', group: 'FRESH_WATER', name: 'No.3 FW Tk (P)', frame: '63~71', capacity: 38.3, spgr: 1.000, verified: true },
  { id: 'fw3_s', group: 'FRESH_WATER', name: 'No.3 FW Tk (S)', frame: '63~71', capacity: 38.3, spgr: 1.000, verified: true },
  { id: 'fw4db_c', group: 'FRESH_WATER', name: 'No.4 FW DB Tk (C)', frame: '17~32', capacity: 38.3, spgr: 1.000, verified: true },
  ...
  // ---- OTHER ----
  { id: 'foam_p', group: 'OTHER', name: 'Foam Tk (P)', frame: '51~55', capacity: 11.3, spgr: 1.000, verified: true },
  { id: 'detergent_s', group: 'OTHER', name: 'Detergent Tk (S)', frame: '51~55', capacity: 11.3, spgr: 1.000, verified: true },
